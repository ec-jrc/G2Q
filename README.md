...
* **[Qlik Sense](https://www.qlik.com/es-es/products/qlik-sense)** is a data analytics platform, used by JRC for internal interactive data analysis and for disseminating dashboards or infogrpahics on the web.
